...
const ARCHIVE_PATH = "./02-inputs/data/archive.json";
const ARTICLES_PATH = "./02-inputs/data/articles.json";
const SOURCE_META = {
  Motor1: {
...
async function main() {
  ...
  console.log(`🎉 当前抓到 ${currentFeed.length} 条，本地归档保留 ${archive.length} 条，最近 ${FEED_RETENTION_DAYS} 天输出 ${outputFeed.length} 条到 ./02-inputs/data/articles.json`);
}
