...
function main() {
  ...
  const statusPath = getArgValue(args, "--status", "./02-inputs/data/automation-status.json");
  const articlesPath = getArgValue(args, "--articles", "./02-inputs/data/articles.json");
